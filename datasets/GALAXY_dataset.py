...
def get_galaxy_dataset(data_root, config):
    ...
    train_dataset = GALAXY_dataset(data_root, transform=train_transform, mode='train', 
                                 img_size=config.data.image_size)
    test_dataset = GALAXY_dataset(data_root, transform=test_transform, mode='val',
                                img_size=config.data.image_size)
