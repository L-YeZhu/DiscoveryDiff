...
from unseendiffusion import UnseenDiffusion
...
def parse_args_and_config():
    ...
    parser.add_argument('--boundary_search_custome', action='store_true')
    ...
    parser.add_argument('--unseen_traj', action='store_true')
    parser.add_argument('--test_func', action='store_true')
    ...
    if args.diffusion_hyperplane:
        ...
        if args.edit_attr is not None:
            args.exp = args.exp + f'_Spa_{new_config.data.category}_{args.edit_attr}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
        else:
            args.exp = args.exp + f'_Spa_{new_config.data.category}_{args.trg_txts}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'       
    elif args.unseen_traj:
        if args.edit_attr is not None:
            args.exp = args.exp + f'_Unseen_{new_config.data.category}_{args.edit_attr}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
        else:
            args.exp = args.exp + f'_Unseen_{new_config.data.category}_{args.trg_txts}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'   
    elif args.test_func:
        if args.edit_attr is not None:
            args.exp = args.exp + f'_Test_{new_config.data.category}_{args.edit_attr}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
        else:
            args.exp = args.exp + f'_Test_{new_config.data.category}_{args.trg_txts}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'   
    elif args.navigation:
        if args.edit_attr is not None:
            args.exp = args.exp + f'_Navigation_{new_config.data.category}_{args.edit_attr}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
        else:
            args.exp = args.exp + f'_Navigation_{new_config.data.category}_{args.trg_txts}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'   
    ...
    elif args.boundary_search_custome:
        if args.edit_attr is not None:
            args.exp = args.exp + f'_SC_{new_config.data.category}_{args.edit_attr}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
        else:
            args.exp = args.exp + f'_SC_{new_config.data.category}_{args.trg_txts}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_train_step}_id{args.id_loss_w}_l1{args.l1_loss_w}_lr{args.lr_clip_finetune}'
        ...
        args.exp = args.exp + f'_EST_{new_config.data.category}'
...
def main():
    ...
    runner = UnseenDiffusion(args, config)
    try:
        if args.spatial:
            runner.spatial()
        elif args.radius:
            ...
            runner.boundary_search_custome()
        elif args.boundary_search:
